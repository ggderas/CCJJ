    ...
    <div class="col-lg-12">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <label><span class="glyphicon glyphicon-globe" aria-hidden="true"></span> Ingreso de datos del tipo de estudiante </label>
            </div>
...
<div class="col-lg-12">
    <div class="panel panel-default">
        <div class="panel-heading">
            <label><span class="glyphicon glyphicon-list" aria-hidden="true"></span> Tipos de estudiantes </label>
        </div>
        <div class="panel-body">
                        ...
                        <section class="content">
                            <div class="table-responsive">
                                <table id= "tableTipoDeEstudiantes" border="1" class='table table-bordered table-hover'>
                                    <thead>
                                        <tr>
                                            <th>Cod Tipo de estudiante</th>
                                            <th>Nombre del tipo de estudiante</th>   
                                            <th>Actualización</th>  
                                            <th>Eliminar</th>                  
                                        </tr>
                                    </thead>
        ...
        <div class="modal-content">
            <form role="form" id="form_Modificar" name="form_insertar" action="#">
                <div class="modal-header" >
                    ...
                    <h4 class="modal-title" id="myModalLabel">Modificar tipo de estudiante</h4>
                </div>
