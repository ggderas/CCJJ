...
include($maindir."conexion/config.inc.php");  
  ...
  try{
    ...
    $mensaje = actualizarCarga($cod_carga,$cod_periodo,$cod_estado,$no_empleado,$dni_empleado,$anio);
    echo $mensaje;
  ...
  function actualizarCarga($cod_carga,$cod_periodo,$cod_estado,$no_empleado,$dni_empleado,$anio){
    $queryString = "UPDATE ca_cargas_academicas SET cod_periodo=".$cod_periodo.", cod_estado=".$cod_estado.
                   ", no_empleado='".$no_empleado."', dni_empleado='".$dni_empleado."', anio=".$anio.
