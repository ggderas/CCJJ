...
include($maindir."conexion/config.inc.php");  
  ...
  try{
    ...
    $mensaje = insertarCarga($cod_periodo,$cod_estado,$no_empleado,$dni_empleado,$anio);
    echo $mensaje;
  ...
  function insertarCarga($cod_periodo,$cod_estado,$no_empleado,$dni_empleado,$anio){
    $queryString = "INSERT INTO ca_cargas_academicas(cod_periodo,cod_estado,no_empleado,dni_empleado,anio) VALUES (".
                   $cod_periodo.",".$cod_estado.",'".$no_empleado."','".$dni_empleado."',".$anio.")";
