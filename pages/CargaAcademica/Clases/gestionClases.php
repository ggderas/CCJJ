                    ...
                    <div class="form-group" id="listaDocentes">
                      ...
                      <div class="col-sm-3">
                        <select class="form-control" id="docentes" name="docentes">
                          <option value=0> Seleccione una opción </option>
                          <?php
                            $query = mysql_query("SELECT No_Empleado, Primer_nombre,Segundo_nombre,Primer_apellido,Segundo_apellido FROM persona p INNER JOIN empleado e ON p.N_Identidad = e.N_Identidad");
                            while($row = mysql_fetch_assoc($query)){
